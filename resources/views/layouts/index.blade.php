...
<body class="js">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-12">
                        <!-- Logo -->
                        <div class="logo">
                            <a href="{{ url('index.html') }}"><img src="{{ asset('/eshop/images/logo.png') }}"
                                    alt="logo"></a>
                        </div>
                        <!--/ End Logo -->
                        <!-- Search Form -->
                    ...
                    <div class="col-lg-2 col-md-3 col-12">
                        <div class="right-bar">
                            ...
                            <div class="sinlge-bar">
                                <a href="{{ url('#') }}" class="single-icon"><i class="fa fa-heart-o"
                                        aria-hidden="true"></i></a>
                            </div>
                            <div class="sinlge-bar">
                                <a href="{{ url('#') }}" class="single-icon"><i class="fa fa-user-circle-o"
                                        aria-hidden="true"></i></a>
                            </div>
                            @if (Auth::check())
                                <div class="sinlge-bar shopping">
                                    <a href="{{ url('#') }}" class="single-icon"><i class="ti-bag"></i> <span
                                    ...
                                    <div class="shopping-item">
                                        ...
                                        <ul class="shopping-list">
                                            ...
                                            @foreach ($kerajangs as $item)
                                                ...
                                                @endphp
                                                <li>
                                                    <form action="{{ route('kerajang.destroy', $item->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('delete')
                                                    ...
                                                    <a class="cart-img" href="{{ url('#') }}"><img
                                                            src="{{ Storage::url($item->produk->foto) }}"
                                                            alt="{{ Storage::url($item->produk->foto) }}"></a>
                                                    <h4><a href="{{ url('#') }}">{{ $item->produk->nama }}</a>
                                                    </h4>
                                                    <p class="quantity">{{ $item->kuantitas }}x - <span
                                                            class="amount">Rp
                                                            {{ number_format($item->produk->harga * $item->kuantitas) }}</span>
                                                    </p>
                                                </li>
                                            @endforeach
                                        </ul>
                                        <div class="bottom">
                                            ...
                                            <a href="{{ route('kerajang.checkout') }}"
                                    ...
                                    <div class="navbar-collapse">
                                        <div class="nav-inner">
                                            <ul class="nav main-menu menu navbar-nav">
                                                ...
                                                <li><a href="{{ url('#') }}">Blog<i
                                                            class="ti-angle-down"></i></a>
                                                    <ul class="dropdown">
                                                        <li><a href="{{ url('blog-single-sidebar.html') }}">Blog
                                                                Single Sidebar</a></li>
                                                    </ul>
                                                </li>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-6 col-12">
                        ...
                        <div class="single-footer about">
                            <div class="logo">
                                <a href="{{ url('index.html') }}"><img src="{{ asset('/eshop/images/logo2.png') }}"
                                        alt="#"></a>
                            </div>
                            ...
                            <p class="call">Got Question? Call us 24/7<span><a
                                        href="{{ url('tel:123456789') }}">+0123 456 789</a></span></p>
                        </div>
                        <!-- End Single Widget -->
                    </div>
    ...
    <div class="modal fade" id="add_cart_modal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary"
                            style="padding: 10px !important">Simpan</button>
                    </div>
                </div>
            </form>
        </div>
